...
az functionapp config appsettings set --name distro-sensor-stats --resource-group distro-cwk-rg --settings SqlConnectionString=Server="Driver=18;Server=tcp:distro-db-server.database.windows.net,1433;Database=distro-db;Uid=sc21pkm;Pwd=distroDB!;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
